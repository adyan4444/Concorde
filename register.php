...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        // Display a hovering text message
        $success_message = "Registration successful! You are now logged in.";
        echo "<script>setTimeout(function() { window.location.href = 'customer_dashboard.php'; }, 2000);</script>";
    } else {
    ...
    <div class="login-container">
        ...
        <div class="login-body">
            <div class="login-welcome">
                ...
                <p>Enter your name, email, and password to create an account</p>
            </div>
